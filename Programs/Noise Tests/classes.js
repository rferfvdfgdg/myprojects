...
Math.valueNoise = function(x,y,seed){
    ...
    var p00 = Math.randomSeeded(((ix+0)+(iy+0)*canvas.width)+seed);
    var p10 = Math.randomSeeded(((ix+1)+(iy+0)*canvas.width)+seed);
    var p01 = Math.randomSeeded(((ix+0)+(iy+1)*canvas.width)+seed);
    var p11 = Math.randomSeeded(((ix+1)+(iy+1)*canvas.width)+seed);
...
Math.perlinNoise = function(x,y,seed){
    ...
    function getNumber(x,y,seed){
        return (Math.randomSeeded(((x+0)+(y+0)*canvas.width)+seed)*10)-5;
    }
...
Math.voronoiNoise = function(x,y,seed,base){
    ...
    function getNumber(x,y,seed){
        return Math.randomSeeded(((x+0)+(y+0)*canvas.width)+seed);
    }
