...
class color3 {
    constructor(r,g,b){
        ...
        if (typeof r == 'string'){
            this.r = parseInt(r.substring(1,3), 16);
            this.g = parseInt(r.substring(3,5), 16);
            this.b = parseInt(r.substring(5,7), 16);
        }
        return this;
    }
    get hex(){
...
const Mouse = new mouse2();

//Mouse Update//
addEventListener('mousemove', (event) => {Mouse.position = new vector2(event.clientX,event.clientY)});
